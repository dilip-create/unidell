...
<head>
	...
	<title>CbTicket - Change Password</title>
	<!-- Favicon-->
	...
	<div class="limiter">
		<div class="container-login100 page-background">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="{{ url('BackEnd/chan4545101dgf4r3645pass35fh34') }}" method="post">
					@csrf 
					...
					<div class="wrap-input100 validate-input" data-validate="Enter new password">
						<input class="input100" type="text" name="npass" id="exampleInputEmail1" placeholder="New Password">
						<i class="material-icons focus-input1001">lock</i>
					</div>
					<div class="wrap-input100 validate-input" data-validate="Enter Confirm password">
						<input class="input100" type="password" name="cpass" id="exampleInputPassword1" placeholder="Confirm Password">
						<i class="material-icons focus-input1001">lock</i>
					</div>
